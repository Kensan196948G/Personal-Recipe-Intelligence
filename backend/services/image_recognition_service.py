...
class ImageRecognitionService:
  ...
  INGREDIENT_DICTIONARY = {
    ...
    "carrot": {"ja": "にんじん", "category": "野菜", "keywords": ["オレンジ", "長い"]},
    "potato": {"ja": "じゃがいも", "category": "野菜", "keywords": ["茶色", "丸い"]},
    ...
    "bell_pepper": {"ja": "ピーマン", "category": "野菜", "keywords": ["緑", "小さい"]},
    "broccoli": {"ja": "ブロッコリー", "category": "野菜", "keywords": ["緑", "房"]},
    ...
    "ground_meat": {"ja": "ひき肉", "category": "肉類", "keywords": ["赤", "細かい"]},
    ...
    "shrimp": {"ja": "エビ", "category": "魚介類", "keywords": ["ピンク", "曲がった"]},
    ...
    "cheese": {"ja": "チーズ", "category": "卵・乳製品", "keywords": ["黄色", "固形"]},
    "butter": {"ja": "バター", "category": "卵・乳製品", "keywords": ["黄色", "固形"]},
    "yogurt": {"ja": "ヨーグルト", "category": "卵・乳製品", "keywords": ["白", "液体"]},
    # 穀物・麺類
    ...
    "sesame_oil": {"ja": "ごま油", "category": "調味料", "keywords": ["茶色", "液体"]},
    # 果物
    "apple": {"ja": "りんご", "category": "果物", "keywords": ["赤", "丸い"]},
    "banana": {"ja": "バナナ", "category": "果物", "keywords": ["黄色", "長い"]},
    "orange": {"ja": "オレンジ", "category": "果物", "keywords": ["オレンジ", "丸い"]},
    "strawberry": {"ja": "いちご", "category": "果物", "keywords": ["赤", "小さい"]},
    "grape": {"ja": "ぶどう", "category": "果物", "keywords": ["紫", "房"]},
    "watermelon": {"ja": "スイカ", "category": "果物", "keywords": ["緑", "大きい"]},
    ...
    "almond": {"ja": "アーモンド", "category": "種実", "keywords": ["茶色", "楕円"]},
    "walnut": {"ja": "くるみ", "category": "種実", "keywords": ["茶色", "凸凹"]},
    "chestnut": {"ja": "栗", "category": "種実", "keywords": ["茶色", "丸い"]},
    "sweet_potato": {"ja": "さつまいも", "category": "芋類", "keywords": ["紫", "長い"]},
    "taro": {"ja": "里芋", "category": "芋類", "keywords": ["茶色", "楕円"]},
    "corn": {"ja": "とうもろこし", "category": "野菜", "keywords": ["黄色", "粒"]},
    "pumpkin": {"ja": "かぼちゃ", "category": "野菜", "keywords": ["オレンジ", "大きい"]},
    "green_beans": {"ja": "いんげん", "category": "野菜", "keywords": ["緑", "細長い"]},
    "asparagus": {"ja": "アスパラガス", "category": "野菜", "keywords": ["緑", "細長い"]},
    "bamboo_shoot": {"ja": "たけのこ", "category": "野菜", "keywords": ["黄色", "円錐"]},
    "burdock": {"ja": "ごぼう", "category": "野菜", "keywords": ["茶色", "細長い"]},
    "lotus_root": {"ja": "れんこん", "category": "野菜", "keywords": ["白", "穴"]},
    "radish": {"ja": "ラディッシュ", "category": "野菜", "keywords": ["赤", "丸い"]},
    "zucchini": {"ja": "ズッキーニ", "category": "野菜", "keywords": ["緑", "長い"]},
    ...
    "bean_sprouts": {"ja": "もやし", "category": "野菜", "keywords": ["白", "細い"]},
    "okra": {"ja": "オクラ", "category": "野菜", "keywords": ["緑", "五角形"]},
    "bitter_melon": {"ja": "ゴーヤ", "category": "野菜", "keywords": ["緑", "凸凹"]},
  }
  ...
  def recognize_from_file(
    self, image_path: Path, max_results: int = 5
  ) -> List[Dict]:
    """
    ファイルパスから画像認識
  ...
  def _recognize_image(
    self, img: Image.Image, max_results: int = 5
  ) -> List[Dict]:
    """
    画像認識実行
  ...
  def _generate_mock_results(self, max_results: int = 5) -> List[Dict]:
    ...
    # ランダムに食材を選択
    ingredients = random.sample(list(self.INGREDIENT_DICTIONARY.keys()), max_results)
  ...
  def get_categories(self) -> List[str]:
    ...
    Returns:
      カテゴリリスト
    """
    categories = set(info["category"] for info in self.INGREDIENT_DICTIONARY.values())
...
def get_image_recognition_service(
  ...
  if _image_recognition_service is None:
    _image_recognition_service = ImageRecognitionService(mode=mode, cache_dir=cache_dir)

...
class TranslationRequest(BaseModel):
  ...
  source_lang: Optional[Language] = Field(None, description="Source language code (auto-detect if None)")
...
class RecipeTranslationResult(BaseModel):
  ...
  ingredients: List[str] = Field(default_factory=list, description="Translated ingredients")
  steps: List[str] = Field(default_factory=list, description="Translated cooking steps")
  cached_count: int = Field(default=0, description="Number of cached translations used")

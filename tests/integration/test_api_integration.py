...
class MockAPIClient:
    ...
    def get(self, endpoint: str, params: dict = None):
        """Mock GET request."""
        return Mock(
            status_code=200, json=lambda: {"status": "ok", "data": {}, "error": None}
        )
    ...
    def put(self, endpoint: str, data: dict = None):
        """Mock PUT request."""
        return Mock(
            status_code=200, json=lambda: {"status": "ok", "data": data, "error": None}
        )

    def delete(self, endpoint: str):
        """Mock DELETE request."""
        return Mock(
            status_code=204, json=lambda: {"status": "ok", "data": None, "error": None}
        )
...
class TestAPIIntegration:
    ...
    def test_create_recipe_success(self, api_client, sample_recipe_payload):
        ...
        response = api_client.post("/api/v1/recipes", data=sample_recipe_payload)
    ...
    def test_create_recipe_missing_title(self, api_client):
        ...
        invalid_payload = {"ingredients": [], "steps": []}
    ...
    def test_create_recipe_invalid_cooking_time(self, api_client):
        ...
        invalid_payload = {"title": "Test", "cooking_time": -10}
    ...
    def test_get_recipes_with_pagination(self, api_client):
        ...
        response = api_client.get("/api/v1/recipes", params={"page": 1, "limit": 10})
    ...
    def test_update_recipe_success(self, api_client, sample_recipe_payload):
        ...
        response = api_client.put(f"/api/v1/recipes/{recipe_id}", data=updated_data)
    ...
    def test_update_recipe_not_found(self, api_client, sample_recipe_payload):
        ...
        with patch.object(api_client, "put") as mock_put:
            ...
            response = api_client.put("/api/v1/recipes/999", data=sample_recipe_payload)
            assert response.status_code == 404
    ...
    def test_partial_update_recipe(self, api_client):
        ...
        response = api_client.put(f"/api/v1/recipes/{recipe_id}", data=partial_data)
    ...
    def test_search_recipes_by_ingredient(self, api_client):
        ...
        response = api_client.get(
            "/api/v1/recipes/search", params={"ingredient": "たまねぎ"}
        )
    ...
    def test_search_recipes_by_tag(self, api_client):
        ...
        response = api_client.get("/api/v1/recipes/search", params={"tag": "簡単"})

        assert response.status_code == 200

    def test_search_recipes_by_title(self, api_client):
        """Test searching recipes by title."""
        response = api_client.get("/api/v1/recipes/search", params={"q": "カレー"})

        assert response.status_code == 200

    def test_filter_recipes_by_cooking_time(self, api_client):
        """Test filtering recipes by cooking time."""
        response = api_client.get("/api/v1/recipes", params={"max_cooking_time": 30})
    ...
    def test_scrape_recipe_from_url(self, api_client):
        ...
        response = api_client.post(
            "/api/v1/recipes/scrape", data={"url": "https://cookpad.com/recipe/12345"}
        )
    ...
    def test_scrape_unsupported_url(self, api_client):
        ...
        with patch.object(api_client, "post") as mock_post:
            ...
            response = api_client.post(
                "/api/v1/recipes/scrape", data={"url": "https://unsupported.com/recipe"}
            )
    ...
    def test_ocr_recipe_extraction(self, api_client):
        ...
        response = api_client.post(
            "/api/v1/recipes/ocr", data={"image_path": "/path/to/image.jpg"}
        )
    ...
    def test_translate_recipe(self, api_client):
        ...
        recipe_id = 1
        response = api_client.post(
            f"/api/v1/recipes/{recipe_id}/translate", data={"target_lang": "en"}
        )
    ...
    def test_batch_create_recipes(self, api_client, sample_recipe_payload):
        ...
        response = api_client.post("/api/v1/recipes/batch", data={"recipes": recipes})
    ...
    def test_import_recipes_json(self, api_client):
        ...
        recipes_data = {
            "recipes": [{"title": "インポートレシピ", "ingredients": [], "steps": []}]
        }

        response = api_client.post("/api/v1/recipes/import", data=recipes_data)
    ...
    def test_api_authentication(self, api_client):
        ...
        with patch.object(api_client, "get") as mock_get:
            ...
            response = api_client.get(
                "/api/v1/recipes", params={"token": "valid_token"}
            )
            assert response.status_code == 200

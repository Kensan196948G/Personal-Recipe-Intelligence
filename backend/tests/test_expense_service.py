...
class TestExpenseService:
    ...
    def test_set_budget(self, expense_service):
        ...
        budget = expense_service.set_budget(
            ...
            category_budgets={"食材": 30000.0, "外食": 15000.0, "その他": 5000.0},
        )
    ...
    def test_get_summary_month(self, expense_service):
        ...
        summary = expense_service.get_summary(
            period="month", date=month_start.isoformat()
        )
    ...
    def test_calculate_trend_increasing(self, expense_service):
        ...
        summary = expense_service.get_summary(
            period="month", date=this_month.isoformat()
        )
    ...
    def test_persistence(self, expense_service):
        ...
        # 予算を設定
        expense_service.set_budget(month="2025-12", total_budget=50000.0)

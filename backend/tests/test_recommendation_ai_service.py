...
class TestRecommendationAIService:
    ...
    def test_personalized_recommendations_with_history(self, service, sample_recipes):
        """履歴ありユーザーへのパーソナライズ推薦"""
        # ユーザー行動を記録
        service.record_activity("user_001", "recipe_001", "cooked")
    ...
    def test_trending_recommendations(self, service, sample_recipes):
        ...
        trending = service.get_trending_recommendations(recipes=sample_recipes, limit=5)
    ...
    def test_diversity_penalty(self, service):
        ...
        penalty_main = service._calculate_diversity_penalty(recipe_main, user_history)
        penalty_side = service._calculate_diversity_penalty(recipe_side, user_history)
